...
import { ArrowRight, FileText, Bot, Activity, Building2, Shield } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white selection:bg-blue-100 selection:text-blue-900 font-sans">
            ...
            <main>
                ...
                <section className="relative pt-20 pb-16 sm:pt-28 sm:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link
                            to="/admin/login"
                            className="w-full sm:w-auto px-8 h-12 bg-white border border-[#E5E7EB] text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#374151] rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-all shadow-sm"
                        >
            ...
            <footer className="border-t border-gray-200 bg-white py-12">
                <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    {/* Footer admin link as fallback */}
                    <Link
                        to="/admin/login"
                        className="text-sm text-[#9CA3AF] hover:text-[#6B7280] flex items-center gap-1.5 transition-colors"
                    >
